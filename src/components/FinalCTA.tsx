...
export default function FinalCTA() {
  ...
  return (
    <section className="py-28 lg:py-40 bg-cream relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-6 sm:px-8 text-center">
        <div ref={ref} className={`reveal ${visible ? 'is-visible' : ''}`}>
          <h2 className="font-display text-5xl sm:text-6xl lg:text-7xl font-semibold tracking-tightest text-ink-900 text-balance leading-[1.05]">
            Your next great project
            <span className="block italic text-iris-600 font-normal">starts here.</span>
          </h2>
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
            <a
              href="#explore"
              className="inline-flex items-center gap-2 rounded-full bg-ink-900 text-cream text-sm font-medium px-7 py-3.5 hover:bg-iris-600 transition-all duration-300 hover:shadow-lg hover:shadow-iris-600/25 active:scale-[0.98] group"
            >
              Explore Designers
